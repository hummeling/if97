...
/**
 * Region 5. This class shouldn't be invoked directly.
 *
...
// <editor-fold defaultstate="collapsed" desc="fields">
    private static final String NAME = "Region 5";
    static final double Tref = 1000, pRef = 1;
...
// </editor-fold>
    ...
    double temperaturePH(double pressure, double enthalpy) {
        ...
        double pi = pressure, eta = enthalpy / 2000, temperature = 0;
