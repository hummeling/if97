...
class Region2 extends Region {
    ...
    private final double[][] Jno, IJnr, IJn2aHS, IJn2bHS, IJn2cHS, IJn2aPH, IJn2aPS, IJn2bPH, IJn2bPS, IJn2cPH, IJn2cPS;

    Region2(String... name) {

        super(name.length == 0 ? "Region 2" : name[0]);
